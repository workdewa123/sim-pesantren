    ...
    <aside id="sidebar" class="fixed inset-y-0 left-0 w-64 bg-emerald-900 text-white flex flex-col justify-between z-40 shadow-xl 
        ...
        <div>
            ...
            <nav class="mt-6 px-4 space-y-1 overflow-y-auto max-h-[calc(100vh-10rem)]">
                <a href="{{ route('admin.pelanggaran.dashboard') }}" class="flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-all duration-150 {{ Route::is('admin.pelanggaran.dashboard') ? 'bg-emerald-800 text-white shadow-inner' : 'text-emerald-100 hover:bg-emerald-800/50' }}">
                    <i class="fa-solid fa-chart-pie mr-3 text-base"></i> Dashboard Info
                </a>
                <a href="{{ route('admin.pelanggaran.index') }}" class="flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-all duration-150 {{ Route::is('admin.pelanggaran.index') ? 'bg-emerald-800 text-white shadow-inner' : 'text-emerald-100 hover:bg-emerald-800/50' }}">
                    <i class="fa-solid fa-list-check mr-3 text-base"></i> Data Pelanggaran
                </a>
            </nav>
        </div>
